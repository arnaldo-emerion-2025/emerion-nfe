object Form1: TForm1
  ...
  object frxReport1: TfrxReport
    ...
    PrintOptions.Printer = 'teste'
    PrintOptions.PrintOnSheet = 0
    PrintOptions.ShowDialog = False
    ReportOptions.CreateDate = 40401.475989294000000000
    ReportOptions.LastChange = 41397.756731875000000000
    ...
    ScriptText.Strings = (
      ...
      '  begin'
        ...
        '    ISSQN.PrintOnParent := False;                               ' +
        '                                            '
      '    memDadosAdicionais.Top := 0;'
      
        '    memInformacoesComplementares.Top := memDadosAdicionais.Top +' +
        ' memDadosAdicionais.Height;'
      
        '    memInformacoesComplementares.Height := memDataHora.Top - mem' +
        'InformacoesComplementares.Top - 0.10;'
      '    memObs.Top := memInformacoesComplementares.Top + 10;      '
      
        '    memFisco.Top := memInformacoesComplementares.Top;           ' +
        '                              '
      '    memFisco.Height := memInformacoesComplementares.Height;'
      '  end'
      '  else'
      '    ISSQN.PrintOnParent := True;  '
      'end;'
      ''
      ...
      'iCodCLP,iCodGrui,iCodSub,iCodPro:integer;    '
      'begin'
      '   if trim(Memo131.Text) <> '#39#39' then'
      '   begin'
      ''
      '   iCodCLP := StrToInt(copy(<DadosProdutos."CProd">,1,1));'
      '   iCodGru := StrToInt(copy(<DadosProdutos."CProd">,2,3));'
      '   iCodSub := StrToInt(copy(<DadosProdutos."CProd">,5,4));'
      
        '   iCodPro := StrToInt(copy(<DadosProdutos."CProd">,9,5));      ' +
        '               '
      '                       '
      '   CodCLP := IntToStr(iCodCLP);'
      '   CodGru := IntToStr(iCodGru);'
      '   CodSub := IntToStr(iCodSub);'
      '   CodPro := IntToStr(iCodPro);'
      ''
      '   Memo131.Text := CodGru+'#39'.'#39'+CodSub+'#39'.'#39'+CodPro;'
      '   end;             '
      '     '
      'end;'
      ''
  ...
  object SQLConnection1: TSQLConnection
    ...
    Params.Strings = (
      'DriverName=Firebird'
      'Database=192.168.5.100:/rede/_wgdad/interbase/portal.fdb'
      'User_Name=SYSDBA'
      'Password=ibsade20')
    Left = 352
    Top = 8
